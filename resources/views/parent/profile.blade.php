                                ...
                                <ul id="questions" class="u-sidebar-nav-menu u-sidebar-nav-menu--second-level" style="display: none;">
                                    ...
                                    <li class="u-sidebar-nav-menu__item">
                                        <a class="u-sidebar-nav-menu__link" href="{{route('teacher.index')}}">
                                            <span class="u-sidebar-nav-menu__item-title active">عرض جميع المدرسين</span>
                                        </a>
                                    </li>
                                    <li class="u-sidebar-nav-menu__item">
                ...
                <section class="profile-area card">
                    <div class="profile-content card-body d-flex">
                        ...
                        <div class="user-about">
                            <h2 class="text-danger"> {{$parent->name}}</h2>
                            <br>
                            <p> {{$parent->email}} :البريد الالكتروني</p>
                            <p> {{$parent->phone_number}} :رقم الهاتف</p>
                            <br>
                            <a href="{{ route('parent.edit',['id'=>$parent->id])}}" class="btn btn-outline-danger pl-4 pr-4">Edit</a>
                            <a href="{{ route('parent.destroy',['id'=>$parent->id])}}" class="btn btn-outline-danger pl-4 pr-4">Delete</a>
                        </div>
                    </div>
                    </section>
            </div>
