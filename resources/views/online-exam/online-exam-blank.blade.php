                ...
                <section class="breadcumb-area card bg-gradient mb-5">
                    <div class="bread-cumb-content card-body d-flex align-items-center">
                        <div class="breadcumb-heading">
                            <h2 class="text-white">استعراض معلومات الأقساط الماليّة لطالب</h2>
                        </div>
                        <div class="breadcumb-image ml-auto">
                            <img src="assets/img/51.png" alt="" width="300">
                        </div>
                    </div>
                </section>
                <!-- End breadcumb-area -->
...
<div class="col">
                                        <label for="title">رقم الطالب التسلسلي</label>
                                        <input type="text" placeholder="Student's ID number">
                                    </div>
									  <div class="col">
                                     									  <label for="title">اسم الطالب الثلاثي</label>
                                    ...
                                    <div class="col">
                                        <a onclick="clc()" class="es-form-btn btn btn-block bg-gradient text-white">عرض</a>
                                    </div>
                      ...
                      <div class="routines-table-wrap">
                                <div class="table-responsive table-routines">
                                    <table class="table">
                                        ...
                                        <tbody>
										  <tr>
                                                <td>القسط الكلي للطالب</td>
                                                <td class="text-center">20500<span class="d-block mt-1"></span></td>
                                            
                                            </tr>
                                            <tr>
                                                <td>المبلغ المدفوع</td>
                                                <td class="text-center">200000s.p <span class="d-block mt-1">20/12/2020</span></td>
											   ...
											   <tr>
                                                <td>اخر تاريخ للدفع</td>
                                                <td class="text-center">2/6/2022<span class="d-block mt-1"></span></td>
