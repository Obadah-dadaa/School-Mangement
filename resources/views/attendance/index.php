            ...
            <section class="breadcumb-area card bg-gradient mb-5">
                <div class="bread-cumb-content card-body d-flex align-items-center">
                    <div class="breadcumb-heading">
                        <span class="text-white" style="padding-left:50px; font-size:50px;"> طلبات الغياب  </span>
                    </div>
                                ...
                                <table class="table mb-0">
                                    <thead class="bg-gradient">
                                            <tr>
				                                ...
				                                <th scope="col" class="text-white text-center">سبب الغياب</th>
				                                <th scope="col" class="text-white text-center">تاريخ الغياب</th>
												<th scope="col" class="text-white text-center">الرد</th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center"> Jenia</td>
												<td class="text-center">7th</td>
												<td class="text-center">1st</td>
												<td class="text-center">sick</td>
												<td class="text-center">2/5/2021</td>
                                                <td class="text-center">
                                                <a href="" class="btn btn-outline-danger es-am-btn">رفض</button>
                                                <a href="" class="btn btn-outline-danger es-am-btn"> موافقة </button>
                                                </td>
                                            </tr>
                                            </tbody>
                                </table>
