                ...
                <section class="profile-area card">
                    <div class="profile-content card-body d-flex">
                        ...
                        <div class="user-about">
                            <h2 class="text-danger"> {{$teacher->name}}</h2>
                            <br>
                            <p> {{$teacher->email}} :البريد الالكتروني</p>
                            <p> {{$teacher->phone_number}} :رقم الهاتف</p>
                            <br>
                            <a href="{{ route('teacher.edit',['id'=>$teacher->id])}}" class="btn btn-outline-danger pl-4 pr-4">Edit</a>
                            <a href="{{ route('teacher.destroy',['id'=>$teacher->id])}}" class="btn btn-outline-danger pl-4 pr-4">Delete</a>
                        </div>
                    </div>
                    </section>
            </div>
