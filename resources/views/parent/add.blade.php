                ...
                <section class="es-form-area">
                    <div class="card">
                        <header class="card-header bg-gradient border-0 pt-5 pb-5 d-flex align-items-center">
                            <h2 class="text-white mb-0" style="padding-left:300px; padding-right:300px;">إضافة حساب مدرس جديد</h2>
                        </header>
                        <div class="card-body">
                            <form action="{{ route('teacher.store') }}" method="POST" class="es-form es-add-form">
                                ...
                                <div class="row">
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="title"> اسم ولي الأمر الثلاثي</label>
                                        <input name="name" type="text" placeholder=" اسم الولي الثلاثي">
                                    </div>
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                    ...
                                    <div  class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <button type="submit" class="btn btn-danger align-items-center"> إضافة الولي</button>
                                      </div>
                                </div>
                            </form>
                        </div>
