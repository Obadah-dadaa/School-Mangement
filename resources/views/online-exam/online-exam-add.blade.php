        ...
        <div class="u-content">
            <div class="u-body">
                ...
                <section class="es-form-area">
                    <div class="card">
                        <header class="card-header bg-gradient border-0 pt-5 pb-5 d-flex ">
                            <h2 class="text-white mb-0">إضافة قسط دراسي جديد لطالب</h2>
                            ...
                            <form action="" class="es-form es-add-form">
                                <div class="row">
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        ...
                                        <input type="text" placeholder="رقم الطالب التسلسلي">
                                    </div>
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                       <label for="title">المبلغ المدفوع</label>
                                        <input type="text" placeholder="المبلغ الدفوع">
                         
                                    </div>
                                       <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="date">تاريخ الدفع</label>                                  
                                        <div class="datepicker-wrap">
                                            <input type="text" id="datepicker" class="datepicker hasDatepicker" placeholder="25/12/2022">
                                        </div>
                                    </div>
                                   
                                    </div>
                                    <div class="col-lg-4 offset-lg-4 col-md-12 text-center">
                                        <a href="" class="btn btn-danger btn-block  bg-gradient border-0 text-white">إضافة</a>        
                                    </div>
                                </div>
