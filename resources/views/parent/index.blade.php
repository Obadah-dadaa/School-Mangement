                ...
                <nav class="u-sidebar-nav">
                    ...
                    <li class="u-sidebar-nav-menu__item">
                        ...
                        <ul id="marks" class="u-sidebar-nav-menu u-sidebar-nav-menu--second-level" style="display: none;">
                            ...
                            <!-- parents -->
                        <li class="u-sidebar-nav-menu__item">
                            <a class="u-sidebar-nav-menu__link active" href="#!" data-target="#students">
                                <i class="far fa-id-card u-sidebar-nav-menu__item-icon"></i>
                            ...
                            <ul id="students" class="u-sidebar-nav-menu u-sidebar-nav-menu--second-level" style="display: none;">
								 ...
								 <li class="u-sidebar-nav-menu__item">
                                    <a class="u-sidebar-nav-menu__link" href="{{ route('parents') }}">
                                        <span class="u-sidebar-nav-menu__item-title active">عرض أولياء الأمور</span>
                                    </a>
                                </li>
                                <li class="u-sidebar-nav-menu__item">
            ...
            <section class="breadcumb-area card bg-gradient mb-5">
                <div class="bread-cumb-content card-body d-flex align-items-center">
                    <div class="breadcumb-heading">
                        <span class="text-white" style="padding-left:50px; font-size:50px;">أولياء الأمور </span>
                    </div>
                                ...
                                <table class="table mb-0">
                                    <thead class="bg-gradient">
                                        <tr>
                                            ...
                                            <th scope="col" class="text-white text-center">اسم الولي</th>
                                            ...
                                            <th scope="col" class=" bd-white text-white text-center"><i class='fas fa-money-check-alt' style='font-size:20px;color:white'></i>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('parent.show',['id'=>$item->id])}}" class="btn btn-outline-danger es-am-btn">الحساب الشخصي</a></td>
                                            <form action="{{route('student.show',['id'=>$item->id])}}">
                                                <input name="parent_id" value="{{$item->id}}" hidden>
                                                <td class="text-center"> <button type="submit" class="btn btn-outline-danger es-am-btn"> إدارة الأبناء</button>
                                                </td>
                                            </form>
                                            <td class="text-center"> <button type="submit" class="btn btn-outline-danger es-am-btn"> إدارة الرسوم المالية</button>
                                            </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
