            ...
            <section class="breadcumb-area card bg-gradient mb-5">
                <div class="bread-cumb-content card-body d-flex align-items-center">
                    <div class="breadcumb-heading">
                        <span class="text-white" style="padding-left:50px; font-size:50px;">مدرسين/مدرسات المدرسة </span>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    <thead class="bg-gradient">
                                        <tr>
                                            <th></th>
                                            <th scope="col" class="text-white text-center">اسم المدرس</th>
                                            <th scope="col" class="text-white text-center">Email</th>
                                            <th scope="col" class="text-white text-center">رقم الهاتف</th>
                                            <th scope="col" class="text-white text-center">إدارة الحساب</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <a href="{{ route('teacher.show',['id'=>$item->id])}}" class="btn btn-outline-danger es-am-btn">عرض</a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
