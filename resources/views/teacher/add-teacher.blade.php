                ...
                <section class="es-form-area">
                    <div class="card">
                        <header class="card-header bg-gradient border-0 pt-5 pb-5 d-flex align-items-center">
                            <h2 class="text-white mb-0" style="padding-left:250px; "> إضافة حساب مدرس جديد</h2>
                        </header>
                        <div class="card-body">
                            <form action="{{ route('teacher.store') }}" method="POST" class="es-form es-add-form">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="title"> اسم المدرس الثلاثي</label>
                                        <input name="name" type="text" placeholder="اسم المدرّس">
                                    </div>

                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="title" >رقم الهاتف</label>
                                        <input  name="phone_number" type="tel" placeholder="+9639########">
                                    </div>
                                    ...
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="class"> المواد </label>
                                        <select id="class" class="es-add-select" multiple>
                                        
                                                <option value="العربيّة">اللغة العربيّة</option>
                                                <option value="الإنجليزيّة">اللغة الإنجليزيّة</option>
                                                <option value="الفرنسيّة">اللغة الفرنسيّة</option> 
                                                <option value="الرياضيات">الرياضيات</option>
                                                   <option value="الجغرافيا">الجغرافيا</option> 
                                                   <option value="التاريخ">التاريخ</option> 
                                                   <option value="الوطنيّة">التربية الوطنيّة</option>					  
                                                      <option value="الرسم">الرسم</option>
                                                         <option value="الموسيقيّة">التربية الموسيقيّة</option>   
                                                         <option value="الرياضيّة">التربية الرياضيّة</option>   
                                                            <option value="الأحياء">علم الأحياء</option>
									  ...
									  <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        ...
                                        <input name="password"  placeholder="كلمة سر">

                                    </div>  <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="title">إعادة إدخال كلمة السّر</label>
                                        <input  name="c-password"  placeholder="كلمة سر">
                                    </div>
                                    <div  class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <button type="submit" class="btn btn-danger align-items-center"> إضافة مدرس</button>
                                      </div>
                                </div>
                            </form>
                        </div>
