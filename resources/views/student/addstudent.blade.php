                ...
                <section class="es-form-area">
                    <div class="card">
                        <header class="card-header bg-gradient border-0 pt-5 pb-5 d-flex align-items-center">
                            <h2 class="text-white mb-0" style="padding-left:270px; ">إضافة معلومات طالب</h2>
                        </header>
                        <div class="card-body">
                            <form action="{{ route('student.store') }}" method="POST" class="es-form es-add-form">
                                ...
                                <div class="row">
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        ...
                                        <input name="first_name" type="text" placeholder="اسم الطالب">
                                    </div>
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="title">الكنية</label>
                                        <input name="last_name" type="text" placeholder="الكنية">
                                    </div>
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="class">الصّف</label>
                                        <select name="" class="es-add-select">
                                    ...
                                    <div  class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <button type="submit" class="btn btn-danger align-items-center"> إضافة طالب</button>
                                    </div>
                                </div>
                            </form>
                        </div>
