        ...
        <aside id="sidebar" class="u-sidebar">
            <div class="u-sidebar-inner bg-gradient bdrs-30">
                ...
                <nav class="u-sidebar-nav">
                    ...
                    <li class="u-sidebar-nav-menu__item">
                        <a class="u-sidebar-nav-menu__link active" href="#!" data-target="#marks">
                ...
                <section class="es-form-area">
                    <div class="card">
                        <header class="card-header bg-gradient border-0 pt-5 pb-5 d-flex align-items-center">
                            <h2 class="text-white mb-0" style="padding-left:300px; padding-right:300px;"> إضافة نتيجة امتحانية </h2>
                        </header>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        ...
                                        <select id="class" class="es-add-select">
                                            <option value="1" data-display="السابع">السابع</option>
                                            <option value="2">الثامن</option>
                                            <option value="3">التاسع</option>
                                        </select>
                                    </div>
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="section">الشعبة</label>
                                        <select name="section_id" class="es-add-select">
                                            <option value="1" data-display="الاولى">الاولى</option>
                                            <option value="2">الثانية</option>
                                            <option value="3">الثالثة</option>
                                        </select>
                                    </div>
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="section">نوع الامتحان</label>
                                        <select name="type" class="es-add-select">
                                            <option value="1" data-display="الاولى">الأول</option>
                                            <option value="2">الثاني</option>
                                            <option value="3">النهائي</option>
                                        </select>
                                    </div>
                                     <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        ...
                                        <select name="subject_id" class="es-add-select">
                                            ...
                                            <option value="3">علم أحياء</option>
                                            <option value="4">فيزياء وكيمياء</option>
                                            <option value="5">تاريخ </option>
                                            <option value="6">جغرافية </option>
                                            <option value="7">تربية قومية </option>
                                            <option value="8">اللغة الانكليزية </option>
                                            <option value="9">اللغة الفرنسية </option>
                                            <option value="10">فنون</option>
                                            <option value="11">تربية رياضية</option>
                                            <option value="12">موسيقا </option>
                                        </select>
                                    </div>
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="marks">العلامة</label>
