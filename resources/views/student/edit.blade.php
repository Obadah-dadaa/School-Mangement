                ...
                <section class="es-form-area" style="padding-top:20px;">
                    <div class="card">
                        <header class="card-header bg-gradient border-0 pt-5 pb-5">
                            <h2 style="padding-left:280px; font-size:40px; color:white;">تعديل معلومات الطالب</h2>
                        </header>
                        <div class="card-body">
                        <form action="{{route('student.update',['id'=>$student->id])}}" method="POST"  class="es-form es-add-form">
                        @csrf
                                <div  class="row">
                                    ...
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="title">الصف</label>
                                        <input name=""  value=السابع>
                                    </div>
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="title">الشعبة</label>
                                        <input name=""  value=الاولى>
                                    </div>
                                    <div  class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <button type="submit" class="btn btn-danger align-items-center"> تعديل </button>
                                    </div>
